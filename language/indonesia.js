exports.private = () =>{
	return`Fitur Private Di Pake Di Grup, Masih Waras Deck?🥴`
	}
exports.wait = () => {
    return `Sabar Deck Masih Loading Jangan spam y🥴 Loading....`
}
exports.ok = () => {
    return `Nih Udah Deck😅☝🏻`
}

exports.err = () => {
    return `Error Deck, Ga Bisa Dipake, Jangan maksain y spam spam block baru tau🥴`
}
exports.erorLink = () => {
    return `Link Apaan Yang Lu kasih? Error Gini🥴`
}
exports.media = () => {
    return `Pilih Deck Jangan Sok Ga Tau🤡`
}
...
exports.wrongFormat = (prefix) => {
    return `Format Nya Salah,Udah Salah Makasin lagi, Jangan Spam Y🤡*${prefix}allmenu*.`
}

exports.emptyMess = () => {
    return `kalo masih waras,kirim oesan tuh minimal p lah jangan kosong gitu ancrit🥴`
}

exports.cmdNotFound = (cmd, prefix) => {
    return `❎ Ini Ga Ada Di list *${cmd}*Lu dapat di mana? ngadi" aja lu Ketik*${prefix}allmenu buat cek menu*`
}

exports.ownerOnly = () => {
    return `Owner Bukan Mau Make CMD Owner Aneh🥴`
}
...
exports.groupOnly = () => {
    return `Command Buat Grup malah di pake di Private, Masih Waras lu?🙄!`
}

exports.adminOnly = () => {
    return `Luwh Itu Bukan Atmin,Jangan Sok Keras Deck🤡`
}

exports.nhFalse = () => {
    return `Kode yang lu kasih itu ga nyambung🙄`
}
...
exports.notAdmin = () => {
    return `Luwh Itu Bukan Atmin Yah Deck🤡`
}

exports.adminAlready = () => {
    return `Dia Udah Atmin Deck🙄`
}

exports.botNotAdmin = () => {
    return `Yah Minimal Ngotak Lah Anj,Gw Ga Atmin,Tapi Luwh Suruh CMD Bot Atmin🙄`
}
...
exports.videoLimit = () => {
    return `Ngotak Anj Itu Kebesaran File nya🙄`
}
...
5. Chat Owner Yang Penting,Ga penting ban *PERMA BLOCK*
...
➡️ Untuk Sekarang Bot Tidak Diperkenankan Untuk Di Sewakan/atau add di banyak grup
...
Arigatou Gozaimasu! Untuk kalian user ramah dan Beberapa orang yg ikut membantu juga dalam project pembuatan XGXBOT
😖🙏
`
}
exports.welcome = () =>{
	return`𝖩𝖺𝗇𝗀𝖺𝗇 𝗅𝗎𝗉𝖺 Intro Tod🤡
