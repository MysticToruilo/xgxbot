exports.private = () =>{
	return`Menu Private Malah Dipake Di Grup😒`
	}
exports.wait = () => {
    return `Sabar deck lagi Loading.......🥴`
}
exports.ok = () => {
    return `Udah Nih Deck😅☝🏻`
}

exports.err = () => {
    return ` Fitur Error Ga Bisa Jangan Spam🥴`
}
exports.erorLink = () => {
    return `Ngasih Link Tapi Error hadeuh🙄`
}
exports.media = () => {
    return `Pilih nih Deck Mau Pake Yang Mana🙄`
}
exports.replyImg = (prefix, command) => {
    return `Foto/Videonya Kaka Reply/Caption kasih ${prefix + command}`
}

exports.wrongFormat = (prefix) => {
    return `Luwh Itu salah formatnya, coba cek kesalahan lu disini🥴*${prefix}allmenu*.`
}

exports.emptyMess = () => {
    return `Kasih Pesan Ke Owner *Note*:Ga Bisa Pesan kosong`
}

exports.cmdNotFound = (cmd, prefix) => {
    return `Ga Ada Menu Ini*${cmd}* Luwh dapat nya darimana? coba cek sini sebelum command🙄*${prefix}allmenu*`
}

exports.ownerOnly = () => {
    return `Luwh Siafah deck? Bukan Owner Make CMD Owner Lawack🥴`
}

exports.doneOwner = () => {
    return `Udah Selesai Ner,Sekarang Mana Gaji Gw?🙄`
}

exports.groupOnly = () => {
    return `CMD group dipake di pribadi😒`
}

exports.adminOnly = () => {
    return `Luwh Bukan Atmin yah deck😅☝🏻`
}
...
exports.notAdmin = () => {
    return `Luwh Itu Bukan Atmin Yah deck,sadar diri dikit lah🥴`
}

exports.adminAlready = () => {
    return `Luwh sehat? Dia Kan ATMIN Lol deck 🥴`
}

exports.botNotAdmin = () => {
    return `Yah Minimal Mikir lah,Gw (bot) kan ga Atmin,luwh suruh suruh paks Cmd buat Bot Atmin,afakah mangsud?😅☝🏻`
}
...
exports.videoLimit = () => {
    return `ngotak lah ancrit,kebesaran itu😅☝🏻`
}
...
4.For +212, I'm So Sorry to say this, you can't use my bot that because All of your country codes mostly like to spam so that it makes WhatsApp bots blocked *PERMA BLOCKED*

5.Don't message owner exp: .menu/.play/.search *OWNER NUMBER IS NOT BOT!* AUTO BLOK IF YOU DO THATS ANYMORE
...
➡️ Untuk sementara bot tidak di perkenankan untuk di sewakan
...
⚠️ Segala kebijakan dan ketentuan XGXBOT di pegang oleh owner dan segala perubahan kebijakan, sewaktu waktu owner berhak mencabut, memblokir user(*﹏*) 
...
exports.welcome = () =>{
	return`𝖩𝖺𝗇𝗀𝖺𝗇 𝗅𝗎𝗉𝖺 𝗂𝗇𝗍𝗋𝗈 tod👎
	
╭ 𝖭𝖺𝗆𝖺 :
├ 𝖴𝗆𝗎𝗋 :
├ 𝖦𝖾𝗇𝖽𝖾𝗋 :
├ 𝖠𝗌𝗄𝗈𝗍 :
╰❒ 𝖯𝖺𝗍𝗎𝗁𝗂 𝗋𝗎𝗅𝖾𝗌 𝗀𝗋𝗎𝗉 𝗒𝖺 𝗄𝖺k,*ga patuh keluar aja tod*
}
exports.leave = () =>{
	return`LOL KELUAR KENA MENTAL?
Goodbye sampah group🥴`
}
exports.source = () =>{
return`*------「 SOURCE CODE 」 ------*
